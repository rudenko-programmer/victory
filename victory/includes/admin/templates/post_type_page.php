<div class="wrap">
    <h1>Типы записей <a href="<?php echo get_site_url();?>/wp-admin/post-new.php?post_type=victory_post_type" class="page-title-action">Добавить новый</a></h1>
</div>
<?php
    global $post;
    global $wp_query;
...
<table class="wp-list-table widefat fixed striped posts">
    ...
    <tr>
        ...
        <th scope="col" class="manage-column">Название типа</th>
